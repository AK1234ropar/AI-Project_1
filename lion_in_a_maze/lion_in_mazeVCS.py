...
def search_algo(n, maze, start, end):
  ...
  print("The total cost incured during search is = "+str(cost))     
...
def print_path_cost(hash,node,lst):
 if(node in hash.keys()):
   ...
   if(t[1]=='S'):
      lst.reverse()
      print("The path taken in search is "+str(lst))
